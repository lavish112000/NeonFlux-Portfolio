          ...
          <div className='space-y-6'>
            <div>
              ...
              <p className='text-gray-300'>
                This portfolio is a showcase of a modern web application built
                with cutting-edge technologies. It leverages AI to dynamically
                curate and display project information, providing an interactive
                and engaging user experience. The design is inspired by
                glassmorphism, with a neon and dark theme.
              </p>
            </div>
            <div>
              <h3 className='text-xl font-semibold text-white mb-4'>
              ...
              <div className='grid grid-cols-2 sm:grid-cols-3 gap-6'>
                {technologies.map(tech => (
                  <div
                    key={tech.name}
                    className='flex flex-col items-center justify-center p-4 glassmorphism rounded-lg gap-2 hover-pop'
                  >
                    {tech.icon}
