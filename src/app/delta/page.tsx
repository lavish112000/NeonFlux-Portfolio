        ...
        <Card className='glassmorphism overflow-hidden'>
          ...
          <CardContent className='p-6 space-y-8'>
              ...
              <div className='space-y-6'>
                <div>
                  ...
                  <p className='text-gray-300'>
                    Project Delta is a Resume Parser designed to automatically
                    extract key information from resumes. This project aims to
                    streamline the process of reviewing and processing resumes
            ...
            <div>
              ...
              <p className='text-gray-300'>
                According to AI analysis, the Resume Parser project demonstrates
                proficiency in natural language processing and data extraction
                techniques. The use of libraries like spaCy and NLTK suggests a
                focus on robust text processing capabilities.
              </p>
            </div>
          </CardContent>
        </Card>
